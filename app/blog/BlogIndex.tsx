        ...
        <div className="relative mx-auto w-full px-6 lg:px-[73px]">
          ...
          {featured && (
            <Link
              ...
              className="group mt-14 grid grid-cols-1 gap-0 overflow-hidden rounded-[25px] bg-white shadow-[0_18px_44px_rgba(0,0,0,0.08)] transition-[translate,box-shadow] duration-150 ease-[var(--ease-out-strong)] hover:-translate-y-0.5 hover:shadow-[0_28px_70px_rgba(0,0,0,0.14)] hover:duration-200 md:grid-cols-2"
            >
              <div className="relative aspect-[16/10] overflow-hidden md:aspect-auto">
                <Image
                  ...
                  className="object-cover transition-transform duration-[400ms] ease-[var(--ease-out-strong)] group-hover:scale-[1.03]"
                />
              </div>
              <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <h2 className="mt-6 font-serif text-[22px] font-bold! leading-[120%] text-[#251f21] transition-colors duration-150 ease-[var(--ease-out-strong)] group-hover:text-brand-orange md:text-[26px]">
                  {featured.title}
                </h2>
                ...
                <div className="mt-7 flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center gap-2 font-body text-[18px] text-[#251f21] underline underline-offset-4 transition-opacity duration-150 ease-[var(--ease-out-strong)] group-hover:opacity-70">
                    Read more
                    <ArrowUpRight />
                  </span>
                </div>
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {/* The reveal lives on a wrapper, not on the card: `.reveal` in
                ...
                on the same element. The featured card above stays out of the
                system entirely — it holds the LCP image. Stagger restarts per
                row (i % 3 · 60ms). */}
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-7">
                    ...
                    <h3 className="mt-5 font-serif text-[22px] font-bold! leading-[125%] text-[#251f21] transition-colors duration-150 ease-[var(--ease-out-strong)] group-hover:text-brand-orange">
                      {post.title}
                    </h3>
            ...
            >
              {page > 1 && (
                <Link
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-[#251f21]/25 text-[#251f21] transition-colors duration-150 ease-[var(--ease-out-strong)] hover:border-[#251f21]/60"
                >
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((n) =>
                n === page ? (
                  ...
                  <Link
                    key={n}
                    href={pageHref(n)}
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-[#251f21]/25 font-body text-[16px] text-[#251f21] transition-colors duration-150 ease-[var(--ease-out-strong)] hover:border-[#251f21]/60"
                  >
                    {n}
                  </Link>
                ),

...
const SUCCESS_STATS = [
  { value: "3.886", title: "Calls handled", desc: "Answered in May" },
  {
    value: "4",
    title: "Locations",
    desc: "One AI answering across every room.",
  },
  {
    value: "14%",
  ...
  { value: "393", title: "SMS sent", desc: "Mostly pickup and waitlist links." },
  {
    value: "90%",
    title: "Oxford calls",
    desc: "Routine questions closed instantly",
  },
];
...
const IMPACT = [
  { v: "670", l: "SMS sent" },
  { v: "80%", l: "Conversion" },
  { v: "2,5x$20", l: "Average spend per party of 2.5" },
];
  ...
  return (
    <main className="bg-cream">
      ...
      <SuccessStats
        ...
        intro="Here's what changed after Aplós stopped letting calls go unanswered. Every metric below comes directly from Aplós's operations during May 2026."
      />

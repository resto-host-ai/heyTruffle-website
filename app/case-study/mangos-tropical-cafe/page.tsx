...
const SUCCESS_STATS = [
  ...
  },
  {
    ...
    desc: "Captured outside business hours.",
  },
  {
    value: "47",
    title: "Host hours saved",
    desc: "Returned to the floor in May.",
  },
  {
    value: "600",
    title: "SMS sent",
    desc: "Mostly experiences and reservations.",
  },
  {
    value: "145",
    title: "After-hour inquiries",
    desc: "82 experience + 63 reservations calls captured after close.",
  },
];
...
export default function MangosTropicalCafeCaseStudy() {
  return (
    <main className="bg-cream">
      ...
      <section className="relative flex min-h-[100svh] flex-col overflow-hidden bg-[#251f21] pb-16 pt-28 text-cream md:pt-32">
        ...
        <div className="relative mx-auto flex w-full max-w-[1536px] flex-1 flex-col px-6 md:px-10">
          ...
          >
            <ChevronLeft />
            Case studies <span className="text-cream/50">/</span> Mango&apos;s
            Tropical Cafe
          </Link>
          ...
          <div className="flex flex-1 flex-col items-center justify-center py-12">
            ...
            <div className="mt-8 flex flex-col items-center">
              <Image
                src="/images/mangotropicallogo.png"
            ...
            <p className="mx-auto mt-6 max-w-[826px] text-center font-body text-[20px] font-normal leading-[140%] text-cream md:text-[26px]">
              Mango&apos;s calls cover everything a night out involves: tables,
              experiences, cover charge, dress code.
            </p>
            <p className="mx-auto mt-6 max-w-[826px] text-center font-body text-[20px] font-normal leading-[140%] text-cream md:text-[26px]">
      ...
      <SuccessStats
        ...
        intro="Here's what changed after Mango's stopped letting calls go unanswered. Every metric below comes directly from Mango's operations during May 2026."
      />
          ...
          <div className="mt-16 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-[minmax(0,1.15fr)_repeat(4,minmax(0,1fr))] lg:items-center">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="mt-4 max-w-[420px] font-body text-[20px] font-normal leading-[140%] md:text-[26px]">
                ...
                directly from Mango&apos;s call data for May 2026.
              </p>
            </div>
            {MEASURED.map((m) => (
              <div
